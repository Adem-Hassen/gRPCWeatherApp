...
def add_WeatherServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCurrentWeather': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=weather_pb2.WeatherRequest.FromString,
                    response_serializer=weather_pb2.WeatherResponse.SerializeToString,
            ),
    }
...
class WeatherService(object):
    ...
    def GetCurrentWeather(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weather.WeatherService/GetCurrentWeather',
            weather_pb2.WeatherRequest.SerializeToString,
            weather_pb2.WeatherResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
